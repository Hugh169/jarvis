...
enum HUDTheme {
    ...
    /// Opaque enough that high-contrast content behind the panel doesn't bleed
    /// through as phantom marks under the text.
    static let scrim = Color(red: 0.078, green: 0.094, blue: 0.129).opacity(0.86)
