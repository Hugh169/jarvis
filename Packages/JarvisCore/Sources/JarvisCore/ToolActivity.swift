...
public enum ToolPresentation {
    ...
    private static let table: [String: Descriptor] = [
        ...
        "list_google_events": .init(title: "Checking your Google calendar", bundleIdentifier: nil, symbolName: "calendar"),
        "create_google_event": .init(title: "Adding to your Google calendar", bundleIdentifier: nil, symbolName: "calendar.badge.plus"),
        "search_mail": .init(title: "Searching your mail", bundleIdentifier: nil, symbolName: "magnifyingglass"),
        "read_mail": .init(title: "Reading a message", bundleIdentifier: nil, symbolName: "envelope.open"),
        "draft_mail": .init(title: "Drafting a reply", bundleIdentifier: nil, symbolName: "square.and.pencil"),
        "send_mail": .init(title: "Sending mail", bundleIdentifier: nil, symbolName: "paperplane"),
